  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {!hideCloseButton && (
          <DialogPrimitive.Close className="absolute right-6 top-6 rounded-full p-2 bg-stone-100 dark:bg-[#161616] hover:bg-muted text-muted-foreground transition-all opacity-70 ring-offset-background hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none z-[82] transform hover:scale-110 active:scale-95 duration-200">
            <X className="h-5 w-5" />
